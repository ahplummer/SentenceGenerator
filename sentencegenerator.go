...
func GetSentence(w http.ResponseWriter, r *http.Request){
	...
	js.LoadStruct(dir + "/donkeys.json")
	js.LoadStruct(dir + "/nouns.json")
	js.LoadStruct(dir + "/adjs.json")
	js.LoadStruct(dir + "/personal_nouns.json")
	js.LoadStruct(dir + "/verbs.json")
	js.LoadStruct(dir + "/prepositions.json")
	js.LoadStruct(dir + "/common.json")
